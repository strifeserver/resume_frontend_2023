  ...
  return (
    <div>
      ...
      >
        ...
        "
        >
          <div className="grid-cols-12 row-span-1 mt-10 ">
            <div className="introDataSection ">
              <div className="mt-2 " style={name_container}>
                <p className="mt-3 single-letter-name mt-5">J</p>
            ...
            <div className="md:col-span-12 lg:col-span-12 xl:col-span-8 ml-5 mt-5 ">
